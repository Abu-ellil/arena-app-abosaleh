    ...
    try {
      const chartInstance = new window.seatsio.SeatingChart({
        ...
        tooltipInfo: (object: any) => {
          ...
          return `${object.category} - ${price} SAR`;
        },
      ...
      <div className="flex items-center justify-center h-[600px] bg-gray-900 rounded-lg">
        <div className="text-center">
          ...
          <button
            ...
            className="mt-4 bg-gray-900 px-6 py-3 rounded-lg text-white text-center hover:bg-gray-800 transition-colors"
          >
            إعادة المحاولة
          </button>
        </div>
      ...
      {selectedSeats.length > 0 && (
        <div className="mt-4 bg-blue-900 rounded-lg p-4">
          ...
          <p className="text-blue-200">
            المجموع: {selectedSeats.reduce((sum, seat) => sum + seat.price, 0)}{" "}
