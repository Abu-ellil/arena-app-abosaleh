        ...
        >
          ...
          {currentSeat && (
            ...
            >
              ...
              <div
                className="text-white text-[8px] px-2 py-1 flex justify-between items-center"
                style={{
                  backgroundColor: getSeatCategoryColor(currentSeat.category),
                }}
              >
                <span className="text-[8px]">{formatPrice(currentSeat.price)}</span>
              ...
              <div className="flex">
                <button
                  ...
                  className="flex-1 bg-gray-400 text-white text-[8px] py-1 px-2 flex items-center justify-center gap-1 hover:bg-gray-500 transition-colors"
                >
                ...
                <button
                  ...
                  className="flex-1 bg-green-500 text-white text-[8px] py-1 px-2 flex items-center justify-center gap-1 hover:bg-green-600 transition-colors"
                >
                  <span>✓</span>
