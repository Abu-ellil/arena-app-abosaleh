    ...
    <div className="min-h-screen bg-dark-lighter flex pt-20 justify-center p-4">
      <div className="p-4 max-w-md h-[50%] w-[70%] text-center shadow-sm  shadow-zinc-800">
        ...
        <button
          ...
          className="w-full bg-gray-900 px-6 py-3 rounded-lg text-white text-center hover:bg-gray-800 transition-colors font-bold text-lg disabled:opacity-50 disabled:cursor-not-allowed"
        >
