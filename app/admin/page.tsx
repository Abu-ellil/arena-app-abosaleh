  ...
  const handleDateChange = (date: Value[]) => {
    ...
    if (Array.isArray(date)) {
      setFormData((prevData) => ({
        ...prevData,
        date: date.map((d: any) => (d instanceof DateObject ? d.format('YYYY-MM-DD') : d)), // Store as array of strings
      }));
    } else if (date) {
      setFormData((prevData) => ({
        ...prevData,
        date: [(date as any).format('YYYY-MM-DD')], // Wrap single date in an array
      }));
    } else {
      setFormData((prevData) => ({
        ...prevData,
        date: [], // Assign an empty array when null or undefined
      }));
    }
  };
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                  ...
                  <div>
                    ...
                    <DatePicker
                      ...
                      inputClass="w-full bg-dark border border-gray-600 rounded-lg px-3 py-2 text-white"
                    />
                  </div>
